...
const ExamineImage = require('../home/assets/examine.png');
      ...
      <ScrollView>
        ...
        {ratingRequire && <Card elevation={5} style={{ margin: 12, borderRadius: 5 }}>
          ...
          <Card.Content>
            ...
            {ratingShow ? <Button style={{ margin: 12, borderRadius: 5, marginTop: 25 }} mode="contained" onPress={ratingSubmit}>সাবমিট করুন</Button> : null}
          </Card.Content>
        </Card>
        }
